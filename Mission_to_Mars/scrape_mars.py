...
def scrape_all():
    ...
    browser = Browser(
        "chrome", executable_path='/Users/ronaldrivas/chromedriver/chromedriver', headless=False)
...
def twitter_weather(browser):
    ...
    # Pause for 5 seconds for Twitter page to load before extracting the html
    time.sleep(5)
